...
from dashpartylib.lib import api, config, util, exceptions, blocks, check, backend, database, transaction, script
...
def initialise_config(database_file=None, log_file=None, api_log_file=None,
    ...
    logger.info('Running v{} of dashparty-lib.'.format(config.VERSION_STRING))
