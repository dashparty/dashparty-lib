...
class move_old_db(Command):
    ...
    def run(self):
        ...
        old_data_dir = appdirs.user_config_dir(appauthor='Dashparty', appname='dashpartyd', roaming=True)
        old_database = os.path.join(old_data_dir, 'dashpartyd.9.db')
        old_database_testnet = os.path.join(old_data_dir, 'dashpartyd.9.testnet.db')
...
setup_options = {
    ...
    'license': 'MIT',
    'description': 'Dashparty Protocol Reference Implementation',
    'keywords': 'dashparty, bitcoin',
    'classifiers': [
    ...
    'download_url': 'https://github.com/Dashparty/dashparty-lib/releases/tag/' + CURRENT_VERSION,
    'provides': ['dashpartylib'],
